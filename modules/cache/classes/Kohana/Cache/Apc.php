 ...
 */
class Apc extends \Kohana\Cache implements Arithmetic {
	...
	protected function __construct(array $config)
	{
		...
		{
			throw new \Kohana\Cache\Exception('PHP APC extension is not available.');
		}
	...
	public function set($id, $data, $lifetime = NULL)
	{
		if ($lifetime === NULL)
		{
			$lifetime = \Kohana\Arr::get($this->_config, 'default_expire', \Kohana\Cache::DEFAULT_EXPIRE);
		}
