...
class DB {
	...
	{
		return new Database\Query\Builder\Alter($table);
	}
	...
	{
		return new Database\Query\Builder\Create($table);
	}
	...
	{
		return new Database\Query\Builder\Drop($type, $name);
	}
	...
	{
		return new Database\Query\Builder\Truncate($table);
	}
