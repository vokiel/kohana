...
class Create extends \Kohana\Database\Query\Builder {
	...
	{		
		...
		parent::__construct(\Kohana\Database::CREATE, '');
	}
	...
	public function compile($db = NULL)
	{
		...
		{
			$sql .= \Kohana\Database\Query\Builder::compile_statement(array($key => $option)).' ';
		}
