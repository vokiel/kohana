...
use Database\Query\Builder\Where as Where;
/**
...
class Select extends Where {
	...
	{
		$this->_join[] = $this->_last_join = new Database\Query\Builder\Join($table, $type);
	...
	public function union($select, $all = TRUE)
	{
		...
		if ( ! $select instanceof Database\Query\Builder\Select)
			Error::handler('first parameter must be a string or an instance of Database_Query_Builder_Select', array(), 'database');
