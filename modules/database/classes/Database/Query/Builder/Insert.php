...
use Database\Query\Builder as Builder;
/**
...
class Insert extends Builder {
	...
	public function values(array $values)
	{
		...
		{
			Error::handler('INSERT INTO ... SELECT statements cannot be combined with INSERT INTO ... VALUES', array(), 'database');
		}
	...
	public function select(Database_Query $query)
	{
		...
		{
			Error::handler('Only SELECT queries can be combined with INSERT queries', array(), 'database');
		}
