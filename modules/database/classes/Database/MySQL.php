...
class MySQL extends Database {
	...
	public function connect()
	{
		...
		if (MySQL::$_set_names === NULL)
		{
			...
			_MySQL::$_set_names = ! function_exists('mysql_set_charset');
		}
		...
		catch (Exception $e)
		{
			...
			Error::handler(':error',
				array(':error' => $e->getMessage()), 'database',
				$e->getCode());
		}
	...
	protected function _select_db($database)
	{
		if ( ! mysql_select_db($database, $this->_connection))
		{
			...
			Error::handler(':error',
				array(':error' => mysql_error($this->_connection)), 'database',
	...
	public function query($type, $sql, $as_object = FALSE, array $params = NULL)
	{
		...
		if (($result = mysql_query($sql, $this->_connection)) === FALSE)
		{
			...
			Error::handler(':error [ :query ]',
				array(':error' => mysql_error($this->_connection), ':query' => $sql), 'database',
				mysql_errno($this->_connection));
		}
