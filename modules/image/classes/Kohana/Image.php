...
abstract class Image {
	...
	public function __construct($file)
	{
		...
		{
			throw new \Kohana\Exception('Not an image or invalid image: :file',
				array(':file' => \Kohana\Debug::path($file)));
		}
	...
	public function __toString()
	{
		...
		catch (\Exception $e)
		{
			if (is_object(Kohana::$log))
			{
				...
				$error = \Kohana\Exception::text($e);

				// Add this exception to the log
				\Kohana\Kohana::$log->add(\Kohana\Log::ERROR, $error);
			}
	...
	public function save($file = NULL, $quality = 100)
	{
		...
		if (is_file($file))
		{
			if ( ! is_writable($file))
			{
				throw new \Kohana\Exception('File must be writable: :file',
					array(':file' => \Kohana\Debug::path($file)));
			}
		}
		else
		{
			...
			{
				throw new \Kohana\Exception('Directory must be writable: :directory',
					array(':directory' => \Kohana\Debug::path($directory)));
			}
		}
