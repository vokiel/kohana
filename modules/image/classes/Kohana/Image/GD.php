...
class GD extends \Kohana\Image {
	...
	public static function check()
	{
		...
		{
			throw new \Kohana\Exception('GD is either not installed or not enabled, check your configuration');
		}

		if (defined('GD_BUNDLED'))
		{
			// Get the version via a constant, available in PHP 5.
			GD::$_bundled = GD_BUNDLED;
		}
		else
		{
			...
			GD::$_bundled = (bool) preg_match('/\bbundled\b/i', $info['GD Version']);
		}
		...
		{
			throw new \Kohana\Exception('GD requires GD version :required or greater, you have :version',
	...
	/**
	 * Runs [GD::check] and loads the image.
	 *
	 * @param   string  $file  image file path
	 * @return  void
	 * @throws  \Kohana\Exception
	 */
	public function __construct($file)
	{
		...
		{
			throw new \Kohana\Exception('Installed GD does not support :type images',
	...
	protected function _do_rotate($degrees)
	{
		if ( ! GD::$_bundled)
		{
			throw new \Kohana\Exception('This method requires :function, which is only available in the bundled version of GD',
	...
	protected function _do_flip($direction)
	{
		...
		if ($direction === \Kohana\Image::HORIZONTAL)
		{
