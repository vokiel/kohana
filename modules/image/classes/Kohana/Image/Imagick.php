 ...
 */
class Imagick extends \Kohana\Image {
	...
	public static function check()
	{
		...
		{
			throw new \Kohana\Exception('Imagick is not installed, or the extension is not loaded');
		}
	...
	/**
	 * Runs [Imagick::check] and loads the image.
	 *
	 * @return  void
	 * @throws  \Kohana\Exception
	 */
	...
	protected function _do_watermark(\Kohana\Image $image, $offset_x, $offset_y, $opacity)
	{
	...
	protected function _get_imagetype($extension)
	{
		...
		switch ($format)
		{
			...
			break;
			default:
				throw new \Kohana\Exception('Installed ImageMagick does not support :type images',
