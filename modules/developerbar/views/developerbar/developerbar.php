...
<?php echo HTML::style('media/developerbar/css/developerbar.css') ?>
<div id="developerbarMain">
	<div id="developerbarToolbar">
		<div>
			<?php echo HTML::image('media/developerbar/img/k.png', array('alt' => 'Kohana DeveloperBar','id' => 'developerbarKohana')) ?>
			<?php echo HTML::image('media/developerbar/img/kohana.png', array('alt' => 'Kohana DeveloperBar','id' => 'developerbarKohanaFull')) ?>
		</div>
		<div class="tabbed">
			<ul class="tabs">
...
if(!(window.jQuery)){
	...
	s.src	= "<?php echo URL::site('media/developerbar/js/jquery.min.js')?>";
	h.appendChild(s);
