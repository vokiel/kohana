...
class Exception extends \Exception {
	...
	public function __construct($message, array $variables = NULL, $code = 0)
	{
		if (defined('E_DEPRECATED'))
		{
			...
			Exception::$php_errors[E_DEPRECATED] = 'Deprecated';
		}
	...
	public static function handler(\Exception $e)
	{
		try
		{
			...
			if ( ! headers_sent())
			{
				...
				header('Content-Type: '.Exception::$error_view_content_type.'; charset='.Kohana::$charset, TRUE, $http_header_status);
			}
			...
			if ($view_file = Kohana::find_file('views', Exception::$error_view))
			{
				include $view_file;
			}
			else
			{
				throw new Exception('Error view file does not exist: views/:file', array(
					':file' => Exception::$error_view,
				));
			}
