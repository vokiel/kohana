 ...
 */
abstract class External extends \Kohana\Request\Client {
	...
	public static function factory(array $params = array(), $client = NULL)
	{
		...
		{
			throw new \Kohana\Exception('Selected client is not a Request_Client_External object.');
		}
	...
	public function execute_request(\Kohana\Request $request, \Kohana\Response $response)
	{
		if (Kohana::$profiling)
		{
			...
			if ($request !== \Kohana\Request::$initial AND Request::$current)
			{
		...
		if (\Kohana\Kohana::$expose)
		{
			$request->headers('user-agent', \Kohana\Kohana::version());
		}
	...
	public function options($key = NULL, $value = NULL)
	{
		...
		elseif ($value === NULL)
		{
			return \Kohana\Arr::get($this->_options, $key);
		}
		else
		{
	 ...
	 * @return  Response
	 */
	abstract protected function _send_message(\Kohana\Request $request, \Kohana\Response $response);
