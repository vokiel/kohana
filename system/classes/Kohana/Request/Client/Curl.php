...
class Curl extends External {
	...
	public function _send_message(\Kohana\Request $request, \Kohana\Response $response)
	{
		...
		{
			throw new \Kohana\Exception('Failed to set CURL options, check CURL documentation: :url',
		...
		if (isset($error))
		{
			throw new \Kohana\Exception('Error fetching remote :url [ status :code ] :error',
	 ...
	 * @return array
	 */
	public function _set_curl_request_method(\Kohana\Request $request, array $options)
	{
		switch ($request->method()) {
			case \Kohana\Request::POST:
				$options[CURLOPT_POST] = TRUE;
				break;
			case \Kohana\Request::PUT:
