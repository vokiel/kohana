...
class File extends Writer {
	...
	public function __construct($directory)
	{
		...
		{
			throw new \Kohana\Exception('Directory :dir must be writable',
				array(':dir' => \Kohana\Debug::path($directory)));
		}
	...
	public function write(array $messages)
	{
		...
		{
			// Create the log file
			file_put_contents($filename, \Kohana\Kohana::FILE_SECURITY.' ?>'.PHP_EOL);
