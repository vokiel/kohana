...
use Request\Client\External as External;
/**
...
class HTTP extends External {
	...
	public function _send_message(Request $request)
	{
		$http_method_mapping = array(
			\HTTP\Request::GET     => \HTTPRequest::METH_GET,
			\HTTP\Request::HEAD    => \HTTPRequest::METH_HEAD,
			\HTTP\Request::POST    => \HTTPRequest::METH_POST,
			\HTTP\Request::PUT     => \HTTPRequest::METH_PUT,
			\HTTP\Request::DELETE  => \HTTPRequest::METH_DELETE,
			\HTTP\Request::OPTIONS => \HTTPRequest::METH_OPTIONS,
			\HTTP\Request::TRACE   => \HTTPRequest::METH_TRACE,
			\HTTP\Request::CONNECT => \HTTPRequest::METH_CONNECT,
		);
		...
		// Set the body
		if ($request->method() == \HTTP\Request::PUT)
		{
